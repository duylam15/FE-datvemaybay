            ...
            <div className='flex'>
              ...
              <div className='form-container p32'>
                <div className='logo-container'>
                  <div className=''>
                    ...
                    <p className='description font16'>
                      Vui lòng điền đầy đủ thông tin cá nhân giống trên
                      CMND/CCCD của bạn.
                    </p>
                  </div>
                  <img
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className='sign'>
                    Bằng cách chia sẻ thông tin liên lạc của bạn, bạn có thể
                    nhận được cuộc gọi hoặc tin nhắn liên quan đến chuyến bay và
                    bất kỳ cập nhật về hành lý nào cho hành trình của bạn.
                  </div>
                  <div className='grid'>
                    <div className='grid-item'>
                  ...
                  <div className='my32'>
                    <div className='form-group checkbox-group'>
                      ...
                      <label htmlFor='terms' className='font14'>
                        ...
                        <span className='underline'>
                          các điều khoản và điều kiện của Bamboo Airways và
                          Bamboo Club.
                        </span>
                      </label>
                    </div>
                    <div className='form-group checkbox-group'>
                      ...
                      <label htmlFor='promotions' className='font14'>
                        Đồng ý nhận thông tin về các chương trình khuyến mãi,
                        sản phẩm và dịch vụ từ Bamboo Airways và các đối tác.
                      </label>
                    </div>
                  </div>
